...
const FURNITURE_ITEMS = [
    // Heavy appliances
    { type: 'rect', width: 75, height: 115, name: 'Fridge', density: 0.003, sprite: 'fridge' },
    { type: 'rect', width: 65, height: 75, name: 'Washer', density: 0.003, sprite: 'washer' },
    { type: 'rect', width: 65, height: 70, name: 'Dryer', density: 0.003, sprite: 'dryer' },
    { type: 'rect', width: 55, height: 38, name: 'Microwave', density: 0.002, sprite: 'microwave' },
    // Large furniture
    { type: 'rect', width: 90, height: 85, name: 'Upright Piano', density: 0.003, sprite: 'piano' },
    { type: 'rect', width: 130, height: 65, name: 'Long Dresser', density: 0.0025, sprite: 'long_dresser' },
    { type: 'rect', width: 55, height: 80, name: 'Chest of Drawers', density: 0.0025, sprite: 'chest_of_drawers' },
    { type: 'rect', width: 45, height: 130, name: 'Grandfather Clock', density: 0.002, sprite: 'grandfather_clock' },
    { type: 'rect', width: 110, height: 65, name: 'Dining Table', density: 0.002, sprite: 'dining_table' },
    { type: 'rect', width: 85, height: 50, name: 'Coffee Table', density: 0.0018, sprite: 'coffee_table' },
    // Medium furniture
    { type: 'rect', width: 55, height: 50, name: 'Nightstand', density: 0.002, sprite: 'nightstand' },
    { type: 'rect', width: 40, height: 70, name: 'Bar Stool', density: 0.001, sprite: 'bar_stool' },
    { type: 'rect', width: 50, height: 80, name: 'Mirror', density: 0.001, sprite: 'mirror' },
    { type: 'rect', width: 75, height: 55, name: 'TV', density: 0.0012, sprite: 'tv' },
    { type: 'rect', width: 30, height: 110, name: 'Floor Lamp', density: 0.0008, sprite: 'floor_lamp' },
    // Outdoor / bulky
    { type: 'rect', width: 75, height: 65, name: 'BBQ Pit', density: 0.002, sprite: 'bbq' },
    { type: 'rect', width: 100, height: 65, name: 'Bicycle', density: 0.001, sprite: 'bicycle' },
    { type: 'rect', width: 60, height: 55, name: 'Lawnmower', density: 0.002, sprite: 'lawnmower' },
    { type: 'rect', width: 70, height: 45, name: 'Wagon', density: 0.0012, sprite: 'wagon' },
    // Small items
    { type: 'rect', width: 45, height: 55, name: 'Plant', density: 0.001, sprite: 'plant' },
    { type: 'rect', width: 40, height: 55, name: 'Trash Can', density: 0.001, sprite: 'trashcan' },
    { type: 'rect', width: 35, height: 70, name: 'Vacuum', density: 0.001, sprite: 'vacuum' },
    { type: 'rect', width: 35, height: 80, name: 'Guitar', density: 0.0008, sprite: 'guitar' },
    // Boxes & small items
    { type: 'rect', width: 55, height: 45, name: 'Large Carton', density: 0.001, sprite: 'large_carton' },
    { type: 'rect', width: 48, height: 35, name: 'Medium Carton', density: 0.001, sprite: 'medium_carton' },
    { type: 'rect', width: 35, height: 28, name: 'Small Carton', density: 0.0008, sprite: 'small_carton' },
    { type: 'rect', width: 40, height: 22, name: 'Book Box', density: 0.0015, sprite: 'book_box' },
    { type: 'rect', width: 55, height: 30, name: 'Toolbox', density: 0.002, sprite: 'toolbox' },
    { type: 'rect', width: 50, height: 35, name: 'Storage Tote', density: 0.0015, sprite: 'tote' },
];
